...
export const User = ({ items_user, onClickInvite, isInvited }: IUserProps) => {
    return (
        <>
            <li>
                <div>
                    <img className="avatar" src={items_user.avatar} alt="User" />
                    <div>
                        <h3>
                            {items_user.first_name} {items_user.last_name}
                        </h3>
                        <p>
                ...
                <img className="action" 
                    onClick={()=>onClickInvite(items_user.id)}  
